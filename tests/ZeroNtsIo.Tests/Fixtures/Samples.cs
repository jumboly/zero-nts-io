...
public static class Samples
{
    ...
    public static IEnumerable<object[]> WktAll2D()
    {
        ...
        yield return new object[] { "MULTIPOLYGON (((0 0, 10 0, 10 10, 0 10, 0 0), (2 2, 4 2, 4 4, 2 4, 2 2), (6 6, 8 6, 8 8, 6 8, 6 6)), ((20 20, 30 20, 30 30, 20 30, 20 20), (22 22, 24 22, 24 24, 22 24, 22 22)))" };
