...
public class EdgeCaseTests
{
    ...
    private readonly IWktReader _v4 = new FastWktReaderV4(Samples.Services);
    private readonly IWkbReader _v4Wkb = new FastWkbReaderV4(Samples.Services);
    private readonly IWkbWriter _ntsW = new NtsWkbWriter();
    ...
    {
        CoordinateAsserts.AssertCoordinatesBitEqual(_nts.Read(wkt), _v4.Read(wkt), ulpTolerance: 1);
    }
    ...
    public void EWKB_srid_flag_is_rejected()
    {
        ...
        Assert.Throws<FormatException>(() => _v4Wkb.Read(ewkb));
    }
